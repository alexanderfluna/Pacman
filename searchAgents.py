...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        # Set the start point to the startingPosition
        self.startPoint = self.startingPosition

        # Set the status of the corners to unvisited state
    ...
    def getStartState(self):
        ...
        return (self.startPoint, self.cornersStatus) # returns start state
...
def cornersHeuristic(state, problem):
    ...
    current_position = state[0] # set the current position
    cornersStatus = state[1] # set cornerstatus: (unvisited/visited)
    ...
    # Calculates all distances from the current position to the goals (unvisited corners)
    distancesFromGoals = []
...
def foodHeuristic(state, problem):
    ...
    start_position = problem.startingGameState # set start position
    food_list = foodGrid.asList() # create list of food items
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        #return search.depthFirstSearch(problem) # dfs
        #return search.aStarSearch(problem) # a*
